...
class DataSource {
    fun loadFunction():List<DataUse>{
        return listOf<DataUse>(
            DataUse(R.drawable.airpods,R.string.Title1,R.string.Price1),
            DataUse(R.drawable.airpodspro3rd,R.string.Title2,R.string.Price2),
            DataUse(R.drawable.airpodspro2nd,R.string.Title3,R.string.Price3),
